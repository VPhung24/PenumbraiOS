...
struct Penumbra_Core_Stake_V1alpha1_CommissionAmount {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  var destination: Penumbra_Core_Crypto_V1alpha1_Address {
    get {return _destination ?? Penumbra_Core_Crypto_V1alpha1_Address()}
  ...
  fileprivate var _destination: Penumbra_Core_Crypto_V1alpha1_Address? = nil
}

/// A list of commission amounts to be minted as part of processing the epoch transition.
struct Penumbra_Core_Stake_V1alpha1_CommissionAmounts {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.

  var notes: [Penumbra_Core_Stake_V1alpha1_CommissionAmount] = []
...
extension Penumbra_Core_Stake_V1alpha1_CommissionAmount: @unchecked Sendable {}
extension Penumbra_Core_Stake_V1alpha1_CommissionAmounts: @unchecked Sendable {}
...
extension Penumbra_Core_Stake_V1alpha1_CommissionAmount: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = _protobuf_package + ".CommissionAmount"
  static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .same(proto: "amount"),
  ...
  static func ==(lhs: Penumbra_Core_Stake_V1alpha1_CommissionAmount, rhs: Penumbra_Core_Stake_V1alpha1_CommissionAmount) -> Bool {
...
extension Penumbra_Core_Stake_V1alpha1_CommissionAmounts: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = _protobuf_package + ".CommissionAmounts"
  static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .same(proto: "notes"),
  ]
  ...
  static func ==(lhs: Penumbra_Core_Stake_V1alpha1_CommissionAmounts, rhs: Penumbra_Core_Stake_V1alpha1_CommissionAmounts) -> Bool {
