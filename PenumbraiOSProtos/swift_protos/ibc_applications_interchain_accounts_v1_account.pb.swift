...
public struct Ibc_Applications_InterchainAccounts_V1_InterchainAccount {
  ...
  public var accountOwner: String = String()

  public var unknownFields = SwiftProtobuf.UnknownStorage()

  public init() {}

  fileprivate var _baseAccount: Cosmos_Auth_V1beta1_BaseAccount?
}
...
extension Ibc_Applications_InterchainAccounts_V1_InterchainAccount: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = _protobuf_package + ".InterchainAccount"
  ...
  public static func ==(lhs: Ibc_Applications_InterchainAccounts_V1_InterchainAccount, rhs: Ibc_Applications_InterchainAccounts_V1_InterchainAccount) -> Bool {
