...
public struct Ibc_Applications_InterchainAccounts_V1_Metadata {
  ...
  public var controllerConnectionID: String = String()

  /// host_connection_id is the connection identifier associated with the host chain
  public var hostConnectionID: String = String()
  ...
  public var txType: String = String()
...
extension Ibc_Applications_InterchainAccounts_V1_Metadata: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Ibc_Applications_InterchainAccounts_V1_Metadata, rhs: Ibc_Applications_InterchainAccounts_V1_Metadata) -> Bool {
