...
public struct Ibc_Lightclients_Tendermint_V1_ConsensusState {
  ...
  fileprivate var _root: Ibc_Core_Commitment_V1_MerkleRoot?
}
...
public struct Ibc_Lightclients_Tendermint_V1_Misbehaviour {
  ...
  fileprivate var _header1: Ibc_Lightclients_Tendermint_V1_Header?
  fileprivate var _header2: Ibc_Lightclients_Tendermint_V1_Header?
}
...
private let _protobuf_package = "ibc.lightclients.tendermint.v1"
...
extension Ibc_Lightclients_Tendermint_V1_ClientState: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  fileprivate class _StorageClass {
    ...
    var _trustLevel: Ibc_Lightclients_Tendermint_V1_Fraction?
    var _trustingPeriod: SwiftProtobuf.Google_Protobuf_Duration?
    var _unbondingPeriod: SwiftProtobuf.Google_Protobuf_Duration?
    var _maxClockDrift: SwiftProtobuf.Google_Protobuf_Duration?
    var _frozenHeight: Ibc_Core_Client_V1_Height?
    var _latestHeight: Ibc_Core_Client_V1_Height?
...
extension Ibc_Lightclients_Tendermint_V1_Header: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  fileprivate class _StorageClass {
    var _signedHeader: Tendermint_Types_SignedHeader?
    var _validatorSet: Tendermint_Types_ValidatorSet?
    var _trustedHeight: Ibc_Core_Client_V1_Height?
    var _trustedValidators: Tendermint_Types_ValidatorSet?
