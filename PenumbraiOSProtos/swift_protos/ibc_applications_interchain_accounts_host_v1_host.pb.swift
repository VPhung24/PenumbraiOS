...
public struct Ibc_Applications_InterchainAccounts_Host_V1_Params {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.

  /// host_enabled enables or disables the host submodule.
  public var hostEnabled: Bool = false

  /// allow_messages defines a list of sdk message typeURLs allowed to be executed on a host chain.
  public var allowMessages: [String] = []
...
extension Ibc_Applications_InterchainAccounts_Host_V1_Params: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Ibc_Applications_InterchainAccounts_Host_V1_Params, rhs: Ibc_Applications_InterchainAccounts_Host_V1_Params) -> Bool {
