...
private let _protobuf_package = "ibc.core.types.v1"
...
extension Ibc_Core_Types_V1_GenesisState: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  fileprivate class _StorageClass {
    var _clientGenesis: Ibc_Core_Client_V1_GenesisState?
    var _connectionGenesis: Ibc_Core_Connection_V1_GenesisState?
    var _channelGenesis: Ibc_Core_Channel_V1_GenesisState?
