...
public struct Tendermint_Types_Part {
  ...
  fileprivate var _proof: Tendermint_Crypto_Proof?
}
...
public struct Tendermint_Types_BlockID {
  ...
  fileprivate var _partSetHeader: Tendermint_Types_PartSetHeader?
}
...
public struct Tendermint_Types_Vote {
  ...
  fileprivate var _blockID: Tendermint_Types_BlockID?
...
public struct Tendermint_Types_SignedHeader {
  ...
  fileprivate var _header: Tendermint_Types_Header?
  fileprivate var _commit: Tendermint_Types_Commit?
}
...
public struct Tendermint_Types_LightBlock {
  ...
  fileprivate var _signedHeader: Tendermint_Types_SignedHeader?
  fileprivate var _validatorSet: Tendermint_Types_ValidatorSet?
}
...
private let _protobuf_package = "tendermint.types"
...
extension Tendermint_Types_Header: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  fileprivate class _StorageClass {
    var _version: Tendermint_Version_Consensus?
    var _chainID: String = String()
    var _height: Int64 = 0
    var _time: SwiftProtobuf.Google_Protobuf_Timestamp?
    var _lastBlockID: Tendermint_Types_BlockID?
