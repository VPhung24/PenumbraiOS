...
public struct Ibc_Applications_Transfer_V1_DenomTrace {
...
public struct Ibc_Applications_Transfer_V1_Params {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
extension Ibc_Applications_Transfer_V1_DenomTrace: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = _protobuf_package + ".DenomTrace"
  ...
  public static func ==(lhs: Ibc_Applications_Transfer_V1_DenomTrace, rhs: Ibc_Applications_Transfer_V1_DenomTrace) -> Bool {
...
extension Ibc_Applications_Transfer_V1_Params: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Ibc_Applications_Transfer_V1_Params, rhs: Ibc_Applications_Transfer_V1_Params) -> Bool {
